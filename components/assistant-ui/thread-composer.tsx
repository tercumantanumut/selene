...
import {
  ...
  normalizePromptEnhancementAttachment,
...
export const Composer: FC<{
  ...
  // Recent user/assistant messages for enhancement grounding. Keep the helper
  // close to the Enhance payload path so lifecycle/task rows and tool-only
  // placeholders cannot crowd out useful conversational context.
  const threadMessages = useThread((th) => th.messages);
  const recentMessages = useMemo(
    () => buildPromptEnhancementHistory(threadMessages),
    [threadMessages]
  );
